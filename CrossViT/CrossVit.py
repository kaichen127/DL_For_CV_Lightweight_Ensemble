...
# Step 3: Load Pretrained CrossViT Model
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
model = create_model('crossvit_15_240', pretrained=True)
model.reset_classifier(num_classes=10)  # CIFAR-10 has 10 classes
...
torch.save(model.state_dict(), "crossvit_finetuned.pth")
print("Model weights saved to 'crossvit_finetuned.pth'")