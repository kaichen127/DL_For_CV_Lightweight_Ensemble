...
Original file is located at
    https://colab.research.google.com/drive/1GZqdO6q3ES9yGM_aLHu_m05op6bKMFgk
"""
...
transform_train = transforms.Compose([
    ...
    transforms.Resize(224),  # Resize to 224x224 for EfficientFormer
    transforms.ToTensor(),
...
# Step 3: Load Pretrained EfficientFormer Model
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
model = create_model('efficientformer_l3', pretrained=True)  # EfficientFormer L3 model
...
torch.save(model.state_dict(), "efficientformer_finetuned.pth")
print("Model weights saved to 'efficientformer_finetuned.pth'")